...
func main() {
	name := "name_example" // string | Name of the profile configuration to delete (default to "##default")
...
**name** | **string** | Name of the profile configuration to delete | [default to &quot;##default&quot;]
