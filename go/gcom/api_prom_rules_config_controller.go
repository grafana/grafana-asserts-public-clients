...
type ApiGetPrometheusRulesSchemaRequest struct {
	ctx         context.Context
	ApiService  *PromRulesConfigControllerAPIService
	xScopeOrgID *string
}
...
// Grafana Tenant/Stack ID
func (r ApiGetPrometheusRulesSchemaRequest) XScopeOrgID(xScopeOrgID string) ApiGetPrometheusRulesSchemaRequest {
	r.xScopeOrgID = &xScopeOrgID
	return r
}

func (r ApiGetPrometheusRulesSchemaRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.GetPrometheusRulesSchemaExecute(r)
}

/*
GetPrometheusRulesSchema Get JSON Schema for Prometheus Rules configuration

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetPrometheusRulesSchemaRequest
*/
func (a *PromRulesConfigControllerAPIService) GetPrometheusRulesSchema(ctx context.Context) ApiGetPrometheusRulesSchemaRequest {
	return ApiGetPrometheusRulesSchemaRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *PromRulesConfigControllerAPIService) GetPrometheusRulesSchemaExecute(r ApiGetPrometheusRulesSchemaRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PromRulesConfigControllerAPIService.GetPrometheusRulesSchema")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
