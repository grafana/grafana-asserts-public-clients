...
*AlertConfigurationAPI* | [**ValidateAlertConfig**](docs/AlertConfigurationAPI.md#validatealertconfig) | **Post** /v1/config/alert-validate | Validate a single alert configuration
*AlertConfigurationAPI* | [**ValidateAlertConfigs**](docs/AlertConfigurationAPI.md#validatealertconfigs) | **Post** /v1/config/alerts-validate | Validate multiple alert configurations
*AlertConfigurationAPI* | [**ValidateDisabledAlertConfig**](docs/AlertConfigurationAPI.md#validatedisabledalertconfig) | **Post** /v1/config/disabled-alert-validate | Validate a single disabled alert configuration
*AlertConfigurationAPI* | [**ValidateDisabledAlertConfigs**](docs/AlertConfigurationAPI.md#validatedisabledalertconfigs) | **Post** /v1/config/disabled-alerts-validate | Validate disabled alert configurations
...
*AssertionSearchControllerAPI* | [**Search3**](docs/AssertionSearchControllerAPI.md#search3) | **Post** /v1/assertions/search | 
...
*CustomLabelRetentionAPI* | [**DeleteConfig**](docs/CustomLabelRetentionAPI.md#deleteconfig) | **Delete** /v1/config/custom-labels | Delete retained label config for the current tenant
*CustomLabelRetentionAPI* | [**GetConfig**](docs/CustomLabelRetentionAPI.md#getconfig) | **Get** /v1/config/custom-labels | Get retained label config for the current tenant
*CustomLabelRetentionAPI* | [**PutConfig**](docs/CustomLabelRetentionAPI.md#putconfig) | **Post** /v1/config/custom-labels | Create or update retained label config for the current tenant
...
*CustomRcaPatternControllerAPI* | [**GetCustomByName**](docs/CustomRcaPatternControllerAPI.md#getcustombyname) | **Get** /v1/patterns/custom/{name} | 
...
*CypherSearchControllerAPI* | [**Search1**](docs/CypherSearchControllerAPI.md#search1) | **Post** /v1/search/cypher | 
...
*EntityScopeControllerAPI* | [**GetAllEntityScopesV2**](docs/EntityScopeControllerAPI.md#getallentityscopesv2) | **Get** /v2/entity_scope | 
*EntityScopeControllerAPI* | [**GetEntityScopes**](docs/EntityScopeControllerAPI.md#getentityscopes) | **Post** /v1/entity_scope | 
*EntityScopeControllerAPI* | [**GetEntityScopesV2**](docs/EntityScopeControllerAPI.md#getentityscopesv2) | **Post** /v2/entity_scope | 
...
*KubernetesEventsAPI* | [**GetAllEvents**](docs/KubernetesEventsAPI.md#getallevents) | **Get** /v1/events | Get all Kubernetes events
*KubernetesEventsAPI* | [**GetEntityEvents**](docs/KubernetesEventsAPI.md#getentityevents) | **Get** /v1/entity/events | Get Kubernetes events for an entity
...
*LogConfigControllerAPI* | [**DeleteConfig4**](docs/LogConfigControllerAPI.md#deleteconfig4) | **Delete** /v1/config/environment/{name} | 
...
*LogDrilldownConfigControllerAPI* | [**DeleteConfig3**](docs/LogDrilldownConfigControllerAPI.md#deleteconfig3) | **Delete** /v2/config/log/{name} | Delete log drilldown configuration
...
*LogDrilldownConfigControllerAPI* | [**ReorderLogConfigPriorities**](docs/LogDrilldownConfigControllerAPI.md#reorderlogconfigpriorities) | **Put** /v2/config/log/reorder | Reorder log drilldown configuration priorities
...
*ModelRulesConfigurationAPI* | [**GetModelRulesOntology**](docs/ModelRulesConfigurationAPI.md#getmodelrulesontology) | **Get** /v1/config/model-rules/ontology | Get OWL ontology for active model rules
*ModelRulesConfigurationAPI* | [**GetModelRulesSchema**](docs/ModelRulesConfigurationAPI.md#getmodelrulesschema) | **Get** /v1/config/model-rules/schema | Get JSON Schema for the Model Rules configuration
...
*ModelRulesConfigurationAPI* | [**PutModelRulesByName**](docs/ModelRulesConfigurationAPI.md#putmodelrulesbyname) | **Put** /v1/config/model-rules/{name} | Create or update custom model rules by name
*ModelRulesConfigurationAPI* | [**SearchModelRules**](docs/ModelRulesConfigurationAPI.md#searchmodelrules) | **Get** /v1/config/model-rules/search | Search model rules by keyword
*ModelRulesConfigurationAPI* | [**ValidateModelRules**](docs/ModelRulesConfigurationAPI.md#validatemodelrules) | **Post** /v1/config/model-rules-validate | Validate custom model rules without persisting
...
*PinnedFiltersConfigControllerAPI* | [**GetPinnedFiltersConfig**](docs/PinnedFiltersConfigControllerAPI.md#getpinnedfiltersconfig) | **Get** /v1/config/display/pinned-filters | 
*PinnedFiltersConfigControllerAPI* | [**PutPinnedFiltersConfig**](docs/PinnedFiltersConfigControllerAPI.md#putpinnedfiltersconfig) | **Post** /v1/config/display/pinned-filters | 
...
*ProfileDrilldownConfigControllerAPI* | [**DeleteConfig2**](docs/ProfileDrilldownConfigControllerAPI.md#deleteconfig2) | **Delete** /v2/config/profile/{name} | Delete profile drilldown configuration
...
*ProfileDrilldownConfigControllerAPI* | [**ReorderProfileConfigPriorities**](docs/ProfileDrilldownConfigControllerAPI.md#reorderprofileconfigpriorities) | **Put** /v2/config/profile/reorder | Reorder profile drilldown configuration priorities
...
*PromRulesConfigControllerAPI* | [**ValidatePromRules**](docs/PromRulesConfigControllerAPI.md#validatepromrules) | **Post** /v1/config/prom-rules-validate-sync | Validate Prometheus rules synchronously without persisting
*RcaPatternControllerAPI* | [**List**](docs/RcaPatternControllerAPI.md#list) | **Post** /v1/patterns/list | 
*RcaPatternControllerAPI* | [**Search2**](docs/RcaPatternControllerAPI.md#search2) | **Post** /v1/patterns/search | 
...
*SearchControllerAPI* | [**SearchCount**](docs/SearchControllerAPI.md#searchcount) | **Post** /v1/search/count | 
...
*StackControllerAPI* | [**AllowLargeTenantOnboarding**](docs/StackControllerAPI.md#allowlargetenantonboarding) | **Post** /v2/stack/allow-large-tenant-onboarding | 
...
*TraceDrilldownConfigControllerAPI* | [**DeleteConfig1**](docs/TraceDrilldownConfigControllerAPI.md#deleteconfig1) | **Delete** /v2/config/trace/{name} | Delete trace drilldown configuration
...
*TraceDrilldownConfigControllerAPI* | [**ReorderTraceConfigPriorities**](docs/TraceDrilldownConfigControllerAPI.md#reordertraceconfigpriorities) | **Put** /v2/config/trace/reorder | Reorder trace drilldown configuration priorities
