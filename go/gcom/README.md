...
For more information, please visit [https://www.asserts.ai/contact](https://www.asserts.ai/contact)
...
*CustomModelRulesControllerAPI* | [**DeleteModelRules**](docs/CustomModelRulesControllerAPI.md#deletemodelrules) | **Delete** /v1/config/model-rules/{name} | 
*CustomModelRulesControllerAPI* | [**GetModelRules**](docs/CustomModelRulesControllerAPI.md#getmodelrules) | **Get** /v1/config/model-rules/{name} | 
*CustomModelRulesControllerAPI* | [**ListModelRules**](docs/CustomModelRulesControllerAPI.md#listmodelrules) | **Get** /v1/config/model-rules | 
*CustomModelRulesControllerAPI* | [**PutModelRules**](docs/CustomModelRulesControllerAPI.md#putmodelrules) | **Put** /v1/config/model-rules | 
*CustomModelRulesControllerAPI* | [**PutModelRules1**](docs/CustomModelRulesControllerAPI.md#putmodelrules1) | **Put** /v1/config/model-rules/{name} | 
...
*DisabledAlertConfigControllerAPI* | [**DeleteDisabledAlertConfig**](docs/DisabledAlertConfigControllerAPI.md#deletedisabledalertconfig) | **Delete** /v1/config/disabled-alert/{name} | 
*DisabledAlertConfigControllerAPI* | [**GetAllDisabledAlertConfigs**](docs/DisabledAlertConfigControllerAPI.md#getalldisabledalertconfigs) | **Get** /v1/config/disabled-alerts | 
*DisabledAlertConfigControllerAPI* | [**GetDisabledHealthAlertConfigs**](docs/DisabledAlertConfigControllerAPI.md#getdisabledhealthalertconfigs) | **Get** /v1/config/disabled-alerts/health | 
*DisabledAlertConfigControllerAPI* | [**GetDisabledRequestAlertConfigs**](docs/DisabledAlertConfigControllerAPI.md#getdisabledrequestalertconfigs) | **Get** /v1/config/disabled-alerts/request | 
*DisabledAlertConfigControllerAPI* | [**GetDisabledResourceAlertConfigs**](docs/DisabledAlertConfigControllerAPI.md#getdisabledresourcealertconfigs) | **Get** /v1/config/disabled-alerts/resource | 
*DisabledAlertConfigControllerAPI* | [**PutDisabledAlertConfig**](docs/DisabledAlertConfigControllerAPI.md#putdisabledalertconfig) | **Post** /v1/config/disabled-alert | 
*DisabledAlertConfigControllerAPI* | [**PutDisabledAlertConfigs**](docs/DisabledAlertConfigControllerAPI.md#putdisabledalertconfigs) | **Post** /v1/config/disabled-alerts | 
...
*LogConfigControllerAPI* | [**DeleteConfig**](docs/LogConfigControllerAPI.md#deleteconfig) | **Delete** /v1/config/environment/{name} | 
...
## Documentation For Models
 ...
 - [ApiErrorException](docs/ApiErrorException.md)
 - [ApiErrorExceptionCause](docs/ApiErrorExceptionCause.md)
 - [ApiErrorExceptionCauseStackTraceInner](docs/ApiErrorExceptionCauseStackTraceInner.md)
