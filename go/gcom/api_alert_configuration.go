...
func (r ApiGetFailureRuleGroupsRequest) CustomFailureRules(customFailureRules string) ApiGetFailureRuleGroupsRequest {
	r.customFailureRules = &customFailureRules
	return r
}

// Set to true to fetch all failure rule groups (custom and default)
func (r ApiGetFailureRuleGroupsRequest) AllFailureRuleGroups(allFailureRuleGroups string) ApiGetFailureRuleGroupsRequest {
...
// Grafana Tenant/Stack ID
func (r ApiValidateDisabledAlertConfigRequest) XScopeOrgID(xScopeOrgID string) ApiValidateDisabledAlertConfigRequest {
	r.xScopeOrgID = &xScopeOrgID
	return r
}

func (r ApiValidateDisabledAlertConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.ValidateDisabledAlertConfigExecute(r)
}

/*
ValidateDisabledAlertConfig Validate a single disabled alert configuration
...
// Grafana Tenant/Stack ID
func (r ApiValidateDisabledAlertConfigsRequest) XScopeOrgID(xScopeOrgID string) ApiValidateDisabledAlertConfigsRequest {
	r.xScopeOrgID = &xScopeOrgID
	return r
}

func (r ApiValidateDisabledAlertConfigsRequest) Execute() (*http.Response, error) {
	return r.ApiService.ValidateDisabledAlertConfigsExecute(r)
}

/*
ValidateDisabledAlertConfigs Validate disabled alert configurations
