...
// checks if the LlmRcaSummarySearchReqDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LlmRcaSummarySearchReqDto{}

// LlmRcaSummarySearchReqDto struct for LlmRcaSummarySearchReqDto
type LlmRcaSummarySearchReqDto struct {
...
type _LlmRcaSummarySearchReqDto LlmRcaSummarySearchReqDto
...
func NewLlmRcaSummarySearchReqDto() *LlmRcaSummarySearchReqDto {
	this := LlmRcaSummarySearchReqDto{}
	return &this
}
...
func (o LlmRcaSummarySearchReqDto) MarshalJSON() ([]byte, error) {
...
func (o LlmRcaSummarySearchReqDto) ToMap() (map[string]interface{}, error) {
...
func (o *LlmRcaSummarySearchReqDto) UnmarshalJSON(data []byte) (err error) {
	varLlmRcaSummarySearchReqDto := _LlmRcaSummarySearchReqDto{}

	err = json.Unmarshal(data, &varLlmRcaSummarySearchReqDto)

	if err != nil {
		return err
	}

	*o = LlmRcaSummarySearchReqDto(varLlmRcaSummarySearchReqDto)
...
type NullableLlmRcaSummarySearchReqDto struct {
	value *LlmRcaSummarySearchReqDto
	isSet bool
}

func (v NullableLlmRcaSummarySearchReqDto) Get() *LlmRcaSummarySearchReqDto {
	return v.value
}

func (v *NullableLlmRcaSummarySearchReqDto) Set(val *LlmRcaSummarySearchReqDto) {
	v.value = val
	v.isSet = true
}

func (v NullableLlmRcaSummarySearchReqDto) IsSet() bool {
	return v.isSet
}

func (v *NullableLlmRcaSummarySearchReqDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLlmRcaSummarySearchReqDto(val *LlmRcaSummarySearchReqDto) *NullableLlmRcaSummarySearchReqDto {
	return &NullableLlmRcaSummarySearchReqDto{value: val, isSet: true}
}

func (v NullableLlmRcaSummarySearchReqDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLlmRcaSummarySearchReqDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
